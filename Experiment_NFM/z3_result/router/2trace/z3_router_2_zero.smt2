...
(assert (distinct T0_0 T0_1 T0_2 T0_3 T0_4 T0_5 T0_6 T0_7 T0_8 T0_9 T0_10 T0_11 T0_12 T0_13 T0_14 T0_15 T0_16 T0_17 T0_18 T1_0 T1_1 T1_2 T1_3 T1_4 T1_5 T1_6 T1_7 T1_8 T1_9 T1_10 T1_11 T1_12 T1_13 T1_14 T1_15 T1_16 T1_17 T1_18 ))

(declare-const sendT0_0 (Send Int Int Int Int))
(assert (and (= (ep sendT0_0) 1) (= (event sendT0_0) T0_0) (= (value sendT0_0) out_0_0)))
...
(assert (and (= (ep sendT0_8) 1) (= (event sendT0_8) T0_8) (= (value sendT0_8) out_0_1)))
...
(assert (and (= (ep sendT1_2) 0) (= (event sendT1_2) T1_2) (= (value sendT1_2) out_1_0)))
...
(assert (and (= (ep sendT1_10) 0) (= (event sendT1_10) T1_10) (= (value sendT1_10) out_1_1)))
...
(assert (and
(HB T0_0 T0_2) (HB T0_2 T0_4) (HB T0_4 T0_5) (HB T0_2 T0_6) (HB T0_2 T0_7) (HB T0_2 T0_8) (HB T0_5 T0_8) (HB T0_8 T0_10) (HB T0_10 T0_12) (HB T0_4 T0_12) (HB T0_12 T0_13) (HB T0_10 T0_14) (HB T0_12 T0_14) (HB T0_14 T0_15) (HB T0_10 T0_16) (HB T0_14 T0_16) (HB T0_16 T0_17) (HB T0_10 T0_18) (HB T1_0 T1_2) (HB T1_2 T1_4) (HB T1_4 T1_5) (HB T1_2 T1_6) (HB T1_2 T1_7) (HB T1_2 T1_8) (HB T1_5 T1_8) (HB T1_8 T1_10) (HB T1_10 T1_12) (HB T1_4 T1_12) (HB T1_12 T1_13) (HB T1_10 T1_14) (HB T1_12 T1_14) (HB T1_14 T1_15) (HB T1_10 T1_16) (HB T1_14 T1_16) (HB T1_16 T1_17) (HB T1_10 T1_18) ))


(assert (and
(or (MATCH recvT1_16 sendT0_10) )
(or (MATCH recvT1_4 sendT0_0) )
(or (MATCH recvT1_14 sendT0_8) )
(or (MATCH recvT0_16 sendT1_10) )
(or (MATCH recvT1_12 sendT0_2) )
(or (MATCH recvT0_14 sendT1_8) )
(or (MATCH recvT0_4 sendT1_0) )
(or (MATCH recvT0_12 sendT1_2) )
))

(assert (= out_0_0 (+ in_0_0 1000)))
(assert (= out_1_0 (+ in_1_0 1000)))

(assert (not ( and (< in_0_0 1000) (>= in_0_3 1000) (< in_1_0 1000) (>= in_1_3 1000) )))
