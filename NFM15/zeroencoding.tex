...
A zero buffer incompatible MPI program deadlocks.
...
%The correctness discussed later proves that this encoding with strict alternation of sends and receives is capable of precisely checking zero buffer incompatibility of an MPI program.
