...
&\text{Property assertion \texttt{P}}  \qquad &&  \neg \mathtt{P}
\end{alignat}
...
\large
\begin{align*}
\bigwedge_{0 \leq i \leq 2} & [(\langle\mathtt{R_{i,4}},\mathtt{S_{(i+1) mod 3}}\rangle \vee  \langle\mathtt{R_{i,6}},\mathtt{S_{(i+2) mod 3}}\rangle)\\
                                          & \wedge(\langle\mathtt{R_{i,4}},\mathtt{S_{(i+1) mod 3}}\rangle  \vee \langle\mathtt{R_{i,6}},\mathtt{S_{(i+2) mod 3}}\rangle)]\\
\end{align*}
\end{minipage}
\end{lrbox}
...
Properties   & \scalebox{0.7}{\usebox{\boxProperty}} & \scalebox{0.7}{\usebox{\boxProperty}}\\
